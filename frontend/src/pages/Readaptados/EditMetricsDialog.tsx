...
export default function EditMetricsDialog({ post, open, onOpenChange, onSave }: Props) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        <DialogHeader>
          <DialogTitle style={{ color: "var(--text-1)", fontFamily: f }}>
            Editar Metricas
          </DialogTitle>
        </DialogHeader>
        ...
        <div className="space-y-4 py-2">
          <div className="grid grid-cols-3 gap-3">
            <div className="space-y-2">
              <Label className="text-xs font-medium" style={{ color: "var(--text-2)" }}>Curtidas</Label>
            ...
            <div className="space-y-2">
              <Label className="text-xs font-medium" style={{ color: "var(--text-2)" }}>Envios</Label>
              <div className="flex items-center gap-2">
                <button
                  type="button"
            ...
            <div className="space-y-2">
              <Label className="text-xs font-medium" style={{ color: "var(--text-2)" }}>Visualizacoes</Label>
              <div className="flex items-center gap-2">
                <button
                  type="button"
        ...
        <DialogFooter style={{ display: "flex", justifyContent: "flex-end", gap: 8, paddingTop: 16 }}>
          <Button
            ...
            className="text-[13px]"
            style={{ color: "var(--text-3)", fontFamily: f }}
          >
            Cancelar
          </Button>
          <Button
            onClick={handleSave}
            className="text-[13px]"
            style={{ background: "var(--accent)", color: "#fff", fontFamily: f }}
          >
            Salvar
          </Button>
        </DialogFooter>
